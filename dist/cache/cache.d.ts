...
export declare const CACHE_REQUEST = "gbe::cache_request";
...
export declare const CACHE_RESPONSE_PREFIX = "gbe::cache_response-";
...
export declare const CACHE_ERROR = "gbe::cache_error";
