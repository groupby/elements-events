...
export declare const AUTOCOMPLETE_REQUEST = "gbe::autocomplete_request";
...
export declare const AUTOCOMPLETE_RESPONSE = "gbe::autocomplete_response";
...
export declare const AUTOCOMPLETE_ERROR = "gbe::autocomplete_error";
