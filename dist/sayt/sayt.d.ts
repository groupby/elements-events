...
export declare const SAYT_HIDE = "sfx::sayt_hide";
/** The type of the [[SAYT_HIDE]] event payload. */
export declare type SaytHidePayload = SaytVisibilityPayload;
/** The name of the event fired when SAYT should be shown. */
export declare const SAYT_SHOW = "sfx::sayt_show";
/** The type of the [[SAYT_SHOW]] event payload. */
export declare type SaytShowPayload = SaytVisibilityPayload;
/**
